...
它适用于支持标准 `SKILL.md` 的 Agent：从一个灵感开书、规划短中长篇、持续连载、审稿修订、导入旧稿续写，以及整理投稿准备材料。它不是某个编辑器或某个模型专用的插件。
...
- 当前版本实现了书籍脚手架、章节暂存与提交、正史/伏笔记录、对账、基础审稿流程和通用投稿包。
...
当前没有声明开源许可证；若计划再分发或接受外部贡献，请先确定许可证。项目借鉴公开作品的架构思路，但不复制受 GPL/AGPL 保护项目的代码、提示词或模板。
